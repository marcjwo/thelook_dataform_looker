...
# # The name of this view in Looker is "Order Items Output Pre"
# view: order_items_output_pre {
#   # The sql_table_name parameter indicates the underlying database table
#   # to be used for all fields in this view.
#   sql_table_name: `semantics-390012.pre_thelook_output.order_items_output_pre` ;;
#   drill_fields: [id]
